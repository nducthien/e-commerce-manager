...
class Footer extends Component {
    render() {
        return (
            <div class="footer" style={{margin: "10px 10px 50px 0px"}}>
                <div class="container">
                    ...
                    <div class="col-md-3 w3_footer_grid">
                        ...
                        <ul class="w3_footer_grid_list">
                            <li>
                                <a href="#">Smart Phone Xiaomi</a>
                            </li>
                            <li>
                                <a href="#">Smart Phone SamSung</a>
                            </li>
                            <li>
                                <a href="#">Smart Phone Apple</a>
                            </li>
                            <li>
                                <a href="#">Smart Phone Huawei</a>
                            </li>
                            <li>
                                <a href="#">Smart Phone Oppo</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-3 w3_footer_grid">
                        ...
                        <ul class="w3_footer_grid_list1">
                            <li>
                                <label class="fa fa-twitter" aria-hidden="true"/>
                                <i>01 day ago</i>
                                <span>
